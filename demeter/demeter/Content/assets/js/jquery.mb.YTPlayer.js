$(document).ready(function($) {
    ...
    $( "a.expand-player" ).click(function() {
    	$( ".YTPOverlay" ).fadeOut( "600", "linear");
    	$( ".lines-overlay" ).fadeOut( "600", "linear");
  		$( "#main" ).fadeOut( "600", "linear", function() {
	...
	$( "a.compress-player" ).click(function() {
		$( ".YTPOverlay" ).fadeIn( "600", "linear");
		$( ".lines-overlay" ).fadeIn( "600", "linear");
